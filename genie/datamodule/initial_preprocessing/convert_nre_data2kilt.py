...
parser.add_argument("--input", type=str, help="The path to the input data folder", default="data/wikipedia_nre/orig")

parser.add_argument("--output", type=str, help="The path to the output folder", default="data/wikipedia_nre")
...
input_file_names = ["train_dataset", "val_dataset", "test_dataset"]
